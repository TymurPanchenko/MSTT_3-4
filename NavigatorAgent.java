...
public class NavigatorAgent extends jade.core.Agent {
    ...
    protected void setup() {
        System.out.println(getAID().getName() + ": Hello Bro!");
    ...
    protected void takeDown() {
        super.takeDown();
        System.out.println(getAID().getName() + ": That`s all, folks");
    }
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                if (!is_busy) {
                    ...
                    System.out.println(getAID().getName() + ": Yeah! It is easy for me");
                    done = true;
                    addBehaviour(new NavigatorAgent.EmailServer());
                } else {
                    reply.setPerformative(ACLMessage.FAILURE);
                    System.out.println(getAID().getName() + ": Sorry. It is impossible");
                }
                myAgent.send(reply);
            } else {
                block();
